			...
			<div class="privacy about">
				...
				<div class="responsive_tabs">
					<div class="resp-tabs-container">
						<!--//tab_one-->
						<div class="pay_info">
							<form action="{{ url('addLesson/update') }}" method="post" enctype="multipart/form-data">
								{{ csrf_field() }}
									...
									<div class="credit-card-wrapper">
										<div class="first-row form-group">
											<div class="controls">
												...
												<input class="form-control" type="text" name="studio_id" id="studio_id" value="{{ $lesson->studio_id }}">
											</div>
											<div class="controls">
											...
											<div class="controls">
												...
												<input class="form-control" type="text" name="price" id="price" value="{{ $lesson->price }}">
											</div>
											<div class="controls">
											...
											<div class="controls">
												...
												<input class="form-control" type="number" name="capacity" id="capacity" value="{{ $lesson->capacity }}">
											</div>
											<div class="controls">
												<label class="control-label">概要</label>
												<textarea class="form-control" name="outline" id="outline">{!! nl2br(e($lesson->outline)) !!}</textarea>
											</div>
											<div class="controls">
