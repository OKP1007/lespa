									...
									<div class="credit-card-wrapper">
										<div class="first-row form-group">
											<div class="controls">
												...
												<input class="form-control" type="text" name="area" id="area" value="{{ $lesson->area }}">
											</div>
											<div class="controls">
											...
											<div class="controls">
												...
												<textarea class="form-control" name="outline" id="outline">{{ $lesson->outline }}</textarea>
											</div>
											<div class="controls">
